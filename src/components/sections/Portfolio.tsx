      ...
      <div className="container mx-auto px-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="relative">
            ...
            <button
              onClick={prevProject}
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-16 z-10 w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-gray-200 flex items-center justify-center hover:border-gray-300 hover:shadow-lg transition-all duration-300 group shadow-md"
            ...
            <button
              onClick={nextProject}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-16 z-10 w-12 h-12 rounded-full bg-white/80 backdrop-blur-sm border border-gray-200 flex items-center justify-center hover:border-gray-300 hover:shadow-lg transition-all duration-300 group shadow-md"
                ...
                >
                  <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[600px]">
                      ...
                      <div className="lg:col-span-8 relative min-h-[400px] lg:min-h-[600px] group">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 bg-white/95 backdrop-blur-sm text-gray-900 px-6 py-3 rounded-full font-medium shadow-lg hover:shadow-xl hover:scale-105 flex items-center gap-2"
                          >
